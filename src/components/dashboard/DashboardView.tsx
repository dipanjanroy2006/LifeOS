...
import { CheckSquare, Flame, Target, Calendar as CalendarIcon, ArrowRight, Zap, CheckCircle2, Circle } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="md:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <StatWidget
            ...
            subtitle={`${Math.round((completedTodayCount / (habitsDueToday.length || 1)) * 100)}% completed today`}
            trend="+12%"
            icon={CheckSquare}
          ...
          <StatWidget
            ...
            value="14 Days"
            subtitle="Longest: 21 Days (Morning Workout)"
            trend="Peak"
            icon={Flame}
          ...
          <StatWidget
            ...
            subtitle="Q3 Key Results on track"
            trend="On Track"
            icon={Target}
